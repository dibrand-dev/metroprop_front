...
export default function ForgotPassword() {
  ...
  return (
    <div className="recuperar-contraseña-container">
      ...
      {showEmailVerificationModal && <EmailVerificationModal title="¡Te enviamos un e-mail para restablecer tu contraseña!" text={`Ingresá a tu casilla de mail para continuar.`} onClose={() => router.push('/login')} />}
    </div>
  );
}